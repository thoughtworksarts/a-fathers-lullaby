...
export const par2017_full = 'The first chapter of the project was launched in 2017, when artist served as Boston Artist-in-Residence with ' +
...
export const par2018Desc1_full = 'In the second chapter, 2018, the project expanded through collaboration with local artists and partnership with ' +
...
export const par2018Desc2_full = 'At 2018 HUBweek, We The Future conference, we prototyped an immersive participatory installation inside a ' +
